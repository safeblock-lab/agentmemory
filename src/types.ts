...
export interface ProviderConfig {
  ...
  baseURL?: string;
  /** Directory containing one validated Gemini account JSON file per project. */
  geminiAccountsDir?: string;
  /** JSON array containing OpenRouter keys used before the paid Fireworks fallback. */
  openRouterKeysFile?: string;
}
...
export type FireworksBatchTask =
  | "consolidation"
  | "graph_extraction"
  | "reflection"
  | "crystallization";
...
export interface FireworksBatchJob {
  ...
  reconciling?: boolean;
  legacyReconciliationAt?: string;
  parserRecovery?: { startedAt: string; activatedAt?: string };
  id: string;
  remoteJobId?: string;
...
export interface ExportData {
  version: "0.3.0" | "0.4.0" | "0.5.0" | "0.6.0" | "0.6.1" | "0.7.0" | "0.7.2" | "0.7.3" | "0.7.4" | "0.7.5" | "0.7.6" | "0.7.7" | "0.7.9" | "0.8.0" | "0.8.1" | "0.8.2" | "0.8.3" | "0.8.4" | "0.8.5" | "0.8.6" | "0.8.7" | "0.8.8" | "0.8.9" | "0.8.10" | "0.8.11" | "0.8.12" | "0.8.13" | "0.9.0" | "0.9.1" | "0.9.2" | "0.9.3" | "0.9.4" | "0.9.5" | "0.9.6" | "0.9.7" | "0.9.8" | "0.9.9" | "0.9.10" | "0.9.11" | "0.9.12" | "0.9.13" | "0.9.14" | "0.9.15" | "0.9.16" | "0.9.17" | "0.9.18" | "0.9.19" | "0.9.20" | "0.9.21" | "0.9.22" | "0.9.23" | "0.9.24" | "0.9.25" | "0.9.26" | "0.9.27" | "0.9.28" | "0.9.29" | "0.9.30" | "0.9.31" | "0.9.32" | "0.9.33" | "0.9.34" | "0.9.35" | "0.9.36" | "0.9.37" | "0.9.38" | "0.9.39" | "0.9.40" | "0.9.41" | "0.9.42" | "0.9.43" | "0.9.44" | "0.9.45" | "0.9.46" | "0.9.47" | "0.9.48" | "0.9.49" | "0.9.50" | "0.9.51" | "0.9.52" | "0.9.53" | "0.9.54" | "0.9.55";
  exportedAt: string;
  sessions: Session[];
